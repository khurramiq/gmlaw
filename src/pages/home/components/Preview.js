            ...
            <Page size="A4" style={styles.page}>
              <View style={styles.section}>
                ...
                <Text style={{ fontSize: '18px', marginTop: '10px' }}>
                  {
                    data.personalInfo
                      .how_many_successor_Trustees_do_you_want_to_name.question
                  }
                </Text>
                ...
                <Text style={{ fontSize: '18px', marginTop: '10px' }}>
                  Do you want the personal representative(s) under your
                  Pour-Over-Will to be the same as your successor trustee(s)
                </Text>
                {data.documentMenu.personalRepresentativeQ.options.map(
                  (item, i) => (
                    <RadioButton isChecked={item.value} label={item.label} />
                  )
                )}
                {data.documentMenu.personalRepresentativeQ.options[1].value && (
                  <div>
                    {data.documentMenu.personalRepresentatives.map(
                      (item, i) => (
                        <>
                          <Text style={{ fontSize: '18px' }}>
                ...
                <Text style={{ fontSize: '18px', marginTop: '10px' }}>
                  Do you want the attorney(s)-in-fact under your Durable Power
                  of Attorney to be the same as your successor trustee(s)
                </Text>
                ...
                {data.preliminaryTrustInfo.question.options[1].value && (
                  <>
                    {data.preliminaryTrustInfo.attorneyInFacts.map(
                      (item, i) => (
                        <>
                          <Text style={{ fontSize: '18px' }}>
                ...
                {data.specialDistributions.question1.options[0].value && (
                  <>
                    <Text style={{ fontSize: '18px', marginTop: '10px' }}>
                      If you have any children under the age of 18 you should
                      name a guardian (or co-Guardians) to take care of them if
                      you cannot. Failure to make arrangements in this regard
                      will leave the decision up to the government.
                    </Text>
                    <Text style={{ fontSize: '18px', marginTop: '10px' }}>
                      Do you want to name a guardian for your minor child or
                      minor children?
                    </Text>
                    {data.specialDistributions.question2.options.map(
                      (item, i) => (
                        <RadioButton
                          isChecked={item.value}
                          label={item.label}
                    ...
                    {data.specialDistributions.question2.options[0].value && (
                      <>
                        ...
                        {data.specialDistributions.question3.options[0]
                          .value && (
                          <>
                            <Text style={{ fontSize: '24px' }}>
                              SINGLE GUARDIANS
                            ...
                            <Text style={{ fontSize: '14px' }}>
                              Name as many guardians as you want. Each one named
                              will act in succession if the prior guardian
                              cannot or will not serve.
                            </Text>
                            <>
                              {data.specialDistributions.guardians.map(
                                (item, i) => (
                                  <>
                                    <Text style={{ fontSize: '18px' }}>
                                      Guardian {i + 1}
                        ...
                        {data.specialDistributions.question3.options[1]
                          .value && (
                          <>
                            <Text style={{ fontSize: '24px' }}>
                            ...
                            <Text style={{ fontSize: '14px' }}>
                              Which co Guardian has priority should the couple
                              divorce or otherwise split up?
                            </Text>
